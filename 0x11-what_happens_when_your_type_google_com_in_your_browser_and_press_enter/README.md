...
- `Website:` A set of files that come together to create a visually appealing page.  
  Every website you browse contains these files: - **_HTML files_** are like the blueprints, defining the structure and content of the page. - **_CSS files_** add styles (_colors, background, font-size .._) to the HTML elements. - **_JavaScript files_** used to make the page come alive and interact with the user. - **_Media files_** like images/video to make things even more interesting!
